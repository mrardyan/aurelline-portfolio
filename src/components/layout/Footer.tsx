...
const SOCIAL_ICONS: Record<string, React.ReactNode> = {
  ...
  thread: (
    <svg className="size-5" fill="currentColor" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg">
...
export function Footer({ scrollToSection, contact }: FooterProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[300px] md:min-h-[400px]">
          ...
          >
            <motion.p
              ...
              className="font-['DM_Serif_Display',serif] text-[32px] md:text-[40px] mb-4 leading-[1] cursor-pointer text-foreground"
            >
              rare
            </motion.p>
            <div className="flex flex-col md:flex-row gap-y-8 md:gap-y-0 md:gap-x-4 justify-between items-start md:items-end">
