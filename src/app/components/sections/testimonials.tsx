...
export function Testimonials({ testimonials }: TestimonialsProps) {
  const [headingRef, headingInView] = useOnceInView<HTMLDivElement>(0.3, "testimonial-heading");
  const [gridRef, gridInView] = useOnceInView<HTMLDivElement>(0.05, "testimonial-grid");

  useEffect(() => {
    console.log("[Testimonials] render — headingInView:", headingInView, "gridInView:", gridInView);
  });
