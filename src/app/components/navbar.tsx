          ...
          <motion.div variants={itemVariants} whileTap={{ scale: 0.95 }}>
            ...
            >
              <div className="relative flex flex-col items-center">
                <motion.span
                  className="inline-block transition-transform duration-300 group-hover:-translate-y-[150%]"
                >
                  Contact
                </motion.span>
                <motion.span
                  className="absolute inline-block translate-y-[150%] transition-transform duration-300 group-hover:translate-y-0"
                >
                  Contact
                </motion.span>
              </div>
